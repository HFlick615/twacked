...
let gameGrid = [
    ...
    { name: 'clown', img: '22.webp' },
    { name: 'safe', img: '18.webp' } // Using 18 as the unique safe card
];
...
function checkForMatch() {
    ...
    if (isMatch) {
        // MATCH FOUND: You are safe! Switch turns.
        matchesFound++;
        disableCards();
...
function switchPlayer() {
    ...
    if (currentPlayer === 1) {
        ...
        body.className = 'p1-turn'; // Switches the CSS theme
    } else {
        statusText.innerText = "PLAYER 2: FIND A MATCH!";
        body.className = 'p2-turn'; // Switches the CSS theme
    }
}
